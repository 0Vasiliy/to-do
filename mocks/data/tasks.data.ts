...
export let tasks: Task[] = [
  ...
  },
  {
    ...
    Description: 'Поболтать о метереологических условиях на даче',
    DueDate: '2026-04-23',
    IsCompleted: false,
    CreatedBy: 2,
    CreatedAt: '2026-03-31',
  },
  {
    ...
    Description: 'Определить причину, и способ решения зависшей задачи',
    DueDate: '2026-04-25',
    IsCompleted: false,
    CreatedBy: 1,
    CreatedAt: '2026-03-31',
  ...
  {
    Id: 11,
    Title: 'Провести диагностику автомобиля',
    Description: 'Провести диагностику автомобиля, определить причину неисправности и способ её устранения',
    DueDate: '2026-04-26',
    IsCompleted: false,
    CreatedBy: 3,
    CreatedAt: '2026-03-31',
